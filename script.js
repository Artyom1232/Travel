...
const venamg=document.querySelectorAll("#venecia img")
console.log(venamg)
window.addEventListener("scroll",function(event){
    console.log (scrollY)
    if(scrollY>4000){
        venamg[0].style.transform="skewY(10deg)"
        venamg[1].style.transform="skewY(-10deg)"
    }
    if(scrollY>4300){
        venamg[0].style.transform="skewY(0)"
        venamg[1].style.transform="skewY(0)"
    }
}
)
